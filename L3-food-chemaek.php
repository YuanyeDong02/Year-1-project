		...
		<div class="blog">
			<div class="container">
						...
						<div class="blog-articals">
							...
							<div class="blog-artical-info">
								...
								<div class="blog-artical-info-img single-head-img">
									 <img src="images/L3-food-chemaek.png" alt="image">
								</div>
				...
				<div class="menu">
					...
					<br>
					<b>QUICK BITES</b><br>
					Sweet potato croquette<br>
					Katsu prawns <br>
					Chicken Corn dog<br>
					Skewered tofu<br>
					Skewered fishballs<br>
					Deep fried chicken dumplings<br>
					Deep fried vegetable dumplings<br>
					<br>
					<b>SPECIALS</b><br>
					Crispy chicken fillet burger<br>
					Kimchi burger<br>
					Chicken stacker burger <br>
					Sweet potato croquette burger<br>
					Korean wrap<br>
					Seoul wrap<br>
					Sweet potato wrap<br>
				...
				<div class="detials">
					<h3>DETAILS</h3>
					<b>menu</b><br>
					https://www.chimaek.uk<br>
					<br>
					<b>address</b><br>
					Hulme Street, Manchester M1 5GL<br>
					<br>
					<b>contect us</b><br>
					0161 236 0188
