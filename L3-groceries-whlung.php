            ...
            <div class="container">
                    ...
                    <div class="blog-articals">
                        <div class="blog-artical">
                            <div class="blog-artical-info">
                                <ul class="product-head">
                                    ...
                                    <li class="active-page"><a href="L3-groceries-whlung.php">W.H.Lung</a></li>
                                    <div class="clear"></div>
                                </ul>
                        ...
                        <div class="container">
                            <div class="col-md-6 social-icons" >
                                ...
                                <iframe height="500" width="810" style="position:relative; margin-left:-600px"
                                        src="https://www.google.com/maps/d/embed?mid=13uxZcvOtOLAh5bQjaUsKexlMFR5Lg8Mq&ehbc=2E312F"></iframe>
                            </div>
                        </div>
                        ...
                        <?php
                            ...
                            function showComments(){
                                ...
                                $sql = "SELECT * FROM Comment WHERE facilityId='17' ORDER BY userCommentTime DESC";
                ...
                <div class="blog-content-right">
                    ...
                    <div class="detials">
                        ...
                        <?php
                            $sql = "SELECT facilityWebsite, facilityAddress, facilityTel FROM Facility WHERE facilityId='17'";
