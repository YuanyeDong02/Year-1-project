            ...
            <div class="container">
                    ...
                    <div class="blog-articals">
                        <div class="blog-artical">
                            <div class="blog-artical-info">
                                ...
                                <li><a href="index.html">Home</a> <span>::</span></li>
                                    ...
                                    <li class="active-page"><a href="L3-drinks-yifang.php">Yifang Fruit Tea</a></li>
                                    <div class="clear"></div>
                                </ul>
                        ...
                        <div class="flip-card">
                            <div class="flip-card-inner">
                                <?php
                                    $sql = "SELECT dishName, dishIngredients FROM Dish WHERE dishId='37'";
                        ...
                        <div class="flip-card" style="position:relative; margin-left:280px; margin-top: -200px">
                            <div class="flip-card-inner">
                                <?php
                                    $sql = "SELECT dishName, dishIngredients FROM Dish WHERE dishId='38'";
                        ...
                        <div class="flip-card" style="position:relative; margin-left:560px; margin-top: -200px">
                            <div class="flip-card-inner">
                                <?php
                                    $sql = "SELECT dishName, dishIngredients FROM Dish WHERE dishId='39'";
                        ...
                        <div class="container">
                            <div class="col-md-6 social-icons" >
                                ...
                                <iframe height="500" width="810" style="position:relative; margin-left:-600px"
                                        src="https://www.google.com/maps/d/embed?mid=1ONbz6B4xx6qmMzjQJzFcaTQdXYpdLquL&ehbc=2E312F"></iframe>
                            </div>
                        </div>
                        ...
                        <?php
                            ...
                            function showComments(){
                                ...
                                $sql = "SELECT * FROM Comment WHERE facilityId='13' ORDER BY userCommentTime DESC";
                ...
                <div class="blog-content-right">
                    ...
                    <div class="detials">
                        ...
                        <?php
                            $sql = "SELECT facilityWebsite, facilityAddress, facilityTel FROM Facility WHERE facilityId='13'";
