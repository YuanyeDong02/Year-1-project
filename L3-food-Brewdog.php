            ...
            <div class="container">
                    ...
                    <div class="blog-articals">
                        ...
                        <div class="flip-card">
                            <div class="flip-card-inner">
                                <?php
                                    $sql = "SELECT dishName, dishIngredients FROM Dish WHERE dishId='16'";
                        ...
                        <div class="flip-card" style="position:relative; margin-left:280px; margin-top: -200px">
                            <div class="flip-card-inner">
                                <?php
                                    $sql = "SELECT dishName, dishIngredients FROM Dish WHERE dishId='17'";
                        ...
                        <div class="flip-card" style="position:relative; margin-left:560px; margin-top: -200px">
                            <div class="flip-card-inner">
                                <?php
                                    $sql = "SELECT dishName, dishIngredients FROM Dish WHERE dishId='18'";
                        ...
                        <div class="container">
                            <div class="col-md-6 social-icons" >
                                ...
                                <iframe height="500" width="810" style="position:relative; margin-left:-600px"
                                        src="https://www.google.com/maps/d/embed?mid=18xd-EgOlE209tHzpx1ZBkOrasYAnuCLN&ehbc=2E312F"></iframe>
                            </div>
                        </div>
                        ...
                        <?php
                            ...
                            function showComments(){
                                ...
                                $sql = "SELECT * FROM Comment WHERE facilityId='6' ORDER BY userCommentTime DESC";
                ...
                <div class="blog-content-right">
                    ...
                    <div class="detials">
                        ...
                        <?php
                            $sql = "SELECT facilityWebsite, facilityAddress, facilityTel FROM Facility WHERE facilityId='6'";
