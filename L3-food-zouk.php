            ...
            <div class="container">
                    ...
                    <div class="blog-articals">
                        <div class="blog-artical">
                            <div class="blog-artical-info">
                                <ul class="product-head">
                                    ...
                                    <li class="active-page"><a href="L3-food-zouk.php">Zouk</a></li>
                                    <div class="clear"></div>
                                </ul>
                                ...
                                <div class="blog-artical-info-img single-head-img">
                                    <img alt="image" src="images/L3-food-zouk.png">
                                </div>
                        ...
                        <div class="flip-card">
                            <div class="flip-card-inner">
                                <?php
                                    $sql = "SELECT dishName, dishIngredients FROM Dish WHERE dishId='28'";
                        ...
                        <div class="flip-card" style="position:relative; margin-left:280px; margin-top: -200px">
                            <div class="flip-card-inner">
                                <?php
                                    $sql = "SELECT dishName, dishIngredients FROM Dish WHERE dishId='29'";
                        ...
                        <div class="flip-card" style="position:relative; margin-left:560px; margin-top: -200px">
                            <div class="flip-card-inner">
                                <?php
                                    $sql = "SELECT dishName, dishIngredients FROM Dish WHERE dishId='30'";
                        ...
                        <div class="container">
                            <div class="col-md-6 social-icons" >
                                ...
                                <iframe height="500" width="810" style="position:relative; margin-left:-600px"
                                        src="https://www.google.com/maps/d/embed?mid=1y60qGYiLyWbU9UHu4ImsFw3VVOuAySwg&ehbc=2E312F"></iframe>
                            </div>
                        </div>
                        ...
                        <?php
                            ...
                            function showComments(){
                                ...
                                $sql = "SELECT * FROM Comment WHERE facilityId='10' ORDER BY userCommentTime DESC";
                ...
                <div class="blog-content-right">
                    ...
                    <div class="detials">
                        ...
                        <?php
                            $sql = "SELECT facilityWebsite, facilityAddress, facilityTel FROM Facility WHERE facilityId='10'";
